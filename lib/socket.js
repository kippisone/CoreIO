...
module.exports = function (CoreIO) {
  ...
  Socket.prototype.start = function () {
    ...
    return new Promise(function (resolve, reject) {
      _this.__socket = _this.getSocketServer();
      _this.__channel = _this.getChannel();
      resolve();
    });
  };
  ...
  Socket.prototype.monitor = function () {
    ...
    if (!this.__socket.monitoring) {
      ...
      this.__socket.monitoring.stats = function () {
        return {
          connections: _this2.__socket.connections.length,
          channels: Object.keys(_this2.__socket.channels)
        };
      };
    }
